...
void Ekf15State::TimeUpdate(const Eigen::Vector3f &accel, const Eigen::Vector3f &gyro, const float dt_s) {
...
void Ekf15State::MeasurementUpdate(const Eigen::Vector3f &ned_vel, const Eigen::Vector3d &lla) {
